...
namespace Pollux.DataBase
{
    static public partial class SqlDataProvider
    {
        ...
        /// par la suite on utilise la variable _connectionString qui contient la chaine de connexion valide
        ...
        static public bool InitialisationConnexion()
        {
            ...
            _connectionString = ConfigurationManager.ConnectionStrings["CastorConnexion"].ConnectionString;
            ...
            do
            {
                try
                {
                    connect = new OleDbConnection(_connectionString);
                    connect.Open();
                ...
                catch (Exception)
                {
                    ...
                    if (resultat == DialogResult.OK)
                    {
                        ...
                        string[] split = _connectionString.Split(new Char[] { '=', ';' });
                        ...
                        if (connexion.DialogResult == DialogResult.OK)
                        {
                            ...
                            _connectionString = "Provider=SQLOLEDB;Data Source=" + connexion.Adresse + ";Integrated Security=SSPI;Initial Catalog=CASTORFINDER;Connect Timeout=2";
                            ConfigModifiee = true;
                        }
                        else return false;
                    }
            ...
            if (ConfigModifiee)
            {
                ...
                config.ConnectionStrings.ConnectionStrings["CastorConnexion"].ConnectionString = _connectionString;
